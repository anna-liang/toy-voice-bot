...
describe('`State Service`', () => {
    ...
    describe('`transitionOut`', () => {
        ...
        it('should transition to the default `action` if a choice does not exist in `choices`', async () => {
            State.state.answer = 'menu3';
            State.state.choices = ['menu1', 'menu2'];
        ...
        it('should transition to a choice if it exists in `choices` disregarding case sensitivity', async () => {
            State.state.answer = 'MENU1';
            State.state.choices = ['menu1', 'menu2'];
